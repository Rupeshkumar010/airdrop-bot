...
def run_generator() -> None:
    ...
    # Load recent updates
    try:
        updates = sheets.get_updates_last_n_hours(hours=72)
    ...
    # Process all updates; tracker promotes actionable airdrop/testnet pages to Medium
    notable_updates = [u for u in updates if str(u.get("Summary", "")).strip()]
